...
class MultiLevel extends events_1.EventEmitter {
    ...
    readStream(id) {
        ...
        return strm ? strm : new events_1.EventEmitter();
    }
    keyStream(id) {
    ...
    createReadStream(options) {
        ...
        this._socket.write(binary_1.binary.packet.encode(packet));
        this._readStreams.set(packet.id, new events_1.EventEmitter());
    ...
    createKeyStream(options) {
        ...
        this._socket.write(binary_1.binary.packet.encode(packet));
        this._keyStreams.set(packet.id, new events_1.EventEmitter());
    ...
    createValueStream(options) {
        ...
        this._socket.write(binary_1.binary.packet.encode(packet));
        this._valueStreams.set(packet.id, new events_1.EventEmitter());
